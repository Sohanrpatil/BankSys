...
<h1 class="alert alert-success rounded-0" style="background-color:powderblue"><?php echo bankName; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:Sohan Patil</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
